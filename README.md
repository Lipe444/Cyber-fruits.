...
-- Criação de uma nova tela GUI
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "NotificationGUI"
ScreenGui.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")

-- Criação de um quadro de notificação
local Frame = Instance.new("Frame")
Frame.Size = UDim2.new(0.3, 0, 0.2, 0) -- Ajuste o tamanho conforme necessário
Frame.Position = UDim2.new(0.35, 0, 0.4, 0) -- Centraliza a interface na tela
Frame.BackgroundColor3 = Color3.fromRGB(128, 0, 128) -- Cor roxa
Frame.Parent = ScreenGui

-- Criação de um texto de notificação
local TextLabel = Instance.new("TextLabel")
TextLabel.Size = UDim2.new(1, 0, 0.5, 0) -- Tamanho do texto
TextLabel.Position = UDim2.new(0, 0, 0, 0) -- Posição do texto dentro do quadro
TextLabel.BackgroundTransparency = 1 -- Texto sem fundo
TextLabel.Text = "Do not Support, Please wait..."
TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255) -- Cor do texto
TextLabel.Font = Enum.Font.SourceSans
TextLabel.TextScaled = true -- Texto ajusta ao tamanho do quadro
TextLabel.Parent = Frame

-- Criação de um botão para sair do jogo
local Button = Instance.new("TextButton")
Button.Size = UDim2.new(1, 0, 0.5, 0) -- Tamanho do botão
Button.Position = UDim2.new(0, 0, 0.5, 0) -- Posição do botão dentro do quadro
...
Button.TextScaled = true -- Texto ajusta ao tamanho do botão
Button.Parent = Frame

-- Função para sair do jogo ao clicar no botão
Button.MouseButton1Click:Connect(function()
    local player = Players.LocalPlayer
    player:Kick("Thank you for waiting. Please come back later.")
end)

-- Função para adicionar um efeito de transição suave à notificação
...
local Window = OrionLib:MakeWindow({Name = "Cyber fruits", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Cyber fruits"})
...
W:AddLabel("[+] Cyber fruits is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Cyber fruits(Noitification)",
